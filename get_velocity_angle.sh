...
# bash get_velocity_angle.sh /home/zez/JI/velocity_map_filled /home/zez/JI/fluxgate/fluxgate_1st.txt 1
work_address=$1
used_file=$2
number=$3
...
output=/home/zez/JI/outputfile_third
echo $output
...
while (($i<$[count]))
	...
	filename_angle=$angle_path/${filename[i]:0:37}angle.filled.grd
	if [ $i = 0 ];then
